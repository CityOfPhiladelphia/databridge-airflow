...
pipeline = DAG('etl_cama_roll_geopetl_v3', schedule_interval=None, default_args=default_args)
...
write_pardat_roll = GeopetlWriteOperator(
    ...
    db_table_name='cama.pardat_roll_v2',
    db_table_where='',
)
...
write_owndat_roll = GeopetlWriteOperator(
    ...
    csv_path='{{ ti.xcom_pull("make_staging") }}/owndat_roll.csv',
    db_conn_id='databridge2',
    db_table_name='cama.owndat_roll_v2',
    db_table_where='',
)
...
write_asmt_roll = GeopetlWriteOperator(
    ...
    csv_path='{{ ti.xcom_pull("make_staging") }}/asmt_roll.csv',
    db_conn_id='databridge2',
    db_table_name='cama.asmt_roll_v2',
    db_table_where='',
)
...
# make_staging.set_downstream(write_pardat_roll)
# make_staging.set_downstream(write_owndat_roll)
# make_staging.set_downstream(write_asmt_roll)


write_pardat_roll.set_downstream(cleanup)
write_owndat_roll.set_downstream(cleanup)
write_asmt_roll.set_downstream(cleanup)
write_splcom.set_downstream(cleanup)
write_proc_roll.set_downstream(cleanup)
