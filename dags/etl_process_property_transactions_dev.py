...
pipeline = DAG('etl_process_property_transactions_dev_v0', schedule_interval=None, default_args=default_args)
...
upsert_records_into_er_stage_transaction = PythonOperator(
    ...
    dag=pipeline,
    python_callable=update_db,
    op_kwargs={'db_conn_id':'databridge2', 'stmt':upsert_er_stage_transaction_test_sql},
)
...
update_er_stage_parcel_q9_resolution_overridden = PythonOperator(
    task_id='update_er_stage_parcel_q9_resolution_overridden',
    dag=pipeline,
    python_callable=update_db,
...
upsert_records_into_er_stage_parcel = PythonOperator(
    ...
    dag=pipeline,
    python_callable=update_db,
    op_kwargs={'db_conn_id':'databridge2', 'stmt':upsert_er_stage_parcel_test_sql},
)
...
property_deeds_new_view_name = 'cama.vw_property_deeds_new_dev'
...
update_er_stage_transaction_q9_review.set_downstream(update_er_stage_parcel_q9_resolution_overridden)
...
make_staging.set_downstream(upsert_records_into_er_stage_parties)
