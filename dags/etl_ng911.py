...
pipeline = DAG('etl_ng911_v0', schedule_interval=None, default_args=default_args)  # TODO: Look up how to schedule a DAG
...
append_new_ng911_site_addresses = GeopetlWriteOperator(
